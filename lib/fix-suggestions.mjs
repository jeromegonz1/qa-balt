...
export const FIX_SUGGESTIONS = {
  ...
  IMG_BROKEN_LAZY_CMS: {
    text: 'Images avec src="" — bug connu du lazy loader CMS AZKO (GSAP). Hors de portee de l\'integrateur. A remonter a l\'equipe dev AZKO pour fix du loader. Workaround temporaire : ajouter loading="lazy" natif sur les images statiques.',
    fileHint: 'code AZKO (lazy loader GSAP) — pas accessible cote integrateur',
    impact: 'ux + seo (bug serveur)',
  },
  IMG_NO_ALT: {
  ...
  MAP_BALT_DEFAULT_LINK: {
    text: 'Le lien "Nous localiser" pointe encore vers la démo BALT (URL Maps fictive du siège Septeo / Labège). À remplacer dans le footer ET la page contact par le vrai lien Google Maps du client.',
    example: '<!-- Récupérer l\'URL : sur https://maps.google.com, chercher l\'adresse client → clic "Partager" → "Copier le lien" -->\n<a href="https://maps.app.goo.gl/<id-réel-client>" target="_blank">Nous localiser</a>',
    fileHint: 'CMS AZKO (champ "lien Maps" de l\'organisation) — répercuté sur footer + page contact via .tpl',
    impact: 'critique pre-MEP (perd toute la valeur SEO local + experience client)',
  },
